...
public class Panel_Kategori extends JPanel implements ActionListener {
    ...
    public Panel_Kategori(){
        ...
        jLabel_judul.setText("Tabel Kategori");
    ...
    void isiTabelAtas(){
        ...
        for (int i = 0; i < parsedData.length; i = i + 2) {
            String[] isi = { parsedData[i].toString(), parsedData[i+1].toString() };
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource().equals(jButton_Add)){
            openFrame(new Frame_Add_Kategori());
        } else 
        if(ae.getSource().equals(jButton_Edit)){
            openFrame(new Frame_Edit_Kategori());
        } else 
        if(ae.getSource().equals(jButton_Delete)){
            openFrame(new Frame_Delete_Kategori());
        }
    }
}
